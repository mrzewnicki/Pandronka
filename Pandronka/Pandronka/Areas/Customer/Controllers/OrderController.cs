...
using Pandronka.Models.ViewModels;
using Pandronka.Utility;

namespace Pandronka.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Pandronka - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
